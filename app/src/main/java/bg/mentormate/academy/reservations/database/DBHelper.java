...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO users(`type`,`email`,`password`,`first_name`,`last_name`,`phone`,`city_id`) VALUES" +
                "(2,'welkowa@gmail.com','1234','Maria','Velkova','+359 887 767 705',1)");
        db.execSQL("INSERT INTO VENUES(`name`,`type`,`city_id`,`address`,`lat`,`lon`,`phone`,`worktime`,`capacity`,`owner_id`,`created`,`last_updated`) VALUES" +
